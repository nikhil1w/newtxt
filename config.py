...
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8486479312:AAF6V8G4adX0hS7f8TCsRl_OfQ8NoMYyxuQ")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Nikhilnroextbot")
BOT_TEXT = "Nikhil Extractor"
# ------------------------------------------------
